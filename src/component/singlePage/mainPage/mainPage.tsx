    ...
    <>
      <section className={style.aboutSection}>
        <div className={style.aboutText}>
          ...
          <ul className={style.aboutList}>
            <li className={style.aboutListItem}>Доставка по всей России бесплатно</li>
            <li className={style.aboutListItem}>Официально зарегистрированное юридическое лицо</li>
            <li className={style.aboutListItem}>Оформление и оплата заказа как в магазине</li>
            <li className={style.aboutListItem}>Только сертифицированные товары из каталога POIZON</li>
            <li className={style.aboutListItem}>Доставили более 10 000 посылок за 3 года</li>
          </ul>
        </div>
      ...
      <section className={style.infoSection}>
        <div className={style.priceContainer}>
          <h3 className={style.priceTitle}>Рассчитай стоимость заказа прямо на сайте</h3>
          <div className={style.priceContainerInput}>
            ...
            />
            <button className={style.priceButton} onClick={calculateRub}>Рассчитать</button>
          </div>
          <h4 className={style.priceTotal}>
            Итоговая стоимость: 
            <br/>{resultRub.toFixed(2)}₽
          </h4>
        </div>
        <img src={infoImg} alt="Походит цена? Скорее заказывай!" className={style.infoImg}/>
      </section>
    </>
  );
}